...
## Install VSCode
First, you need to have VSCode installed, which [can be done here](https://code.visualstudio.com/download).

## Install Docker
Next, you must have Docker installed. If you have not already done so, please follow the instructions at [[Installing Docker]].
...
Your project directory (`OS_Projects`) should have the `.devcontainer` directory at the root.
